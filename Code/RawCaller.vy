...
"""
VD trong uniswap, ta dùng dynamic array address[] để truyền vào 1 mảng các address để tìm ra address cặp pair nào đến được cái token cần lấy. Nhưng trong Vyper không có dynamic array => buộc dùng raw_call
"""
event Log:
    message: String[100]
    val: uint256
