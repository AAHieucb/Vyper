...
Ở đây ta ký bằng piv key của ta và mọi người đều vào xác nhận được rằng ta đã ký cái message bằng cách đưa cho họ signature và message, họ sẽ cho ra đúng pubkey của ta vì phải ký từ pivkey của ta mới cho ra pubkey cặp vs nó đc
"""
