...
# Mỗi lần muốn lấy cái list được confirm => duyệt mọi block từ đầu tới lastest block lấy mọi event tên là Authorized và lấy mọi address -> nếu True thì thêm vào mảng, nếu False thì bỏ ra khỏi mảng, cuối cùng là có list address -> thao tác này tùy vào lúc đó viết bằng gì, thg là JS
...
# send ether vào address khác. Hàm send sẽ forward 2300 gas có nghĩa là VD nó gửi cho 1 contract khác có hàm __default__ thì hàm __default__ đó chỉ được sử dụng max 2300 gas nên msg.gas trả lượng gas remain của nó luôn < 2300, còn bth thì gasLeft rất lớn 
@external
@payable
